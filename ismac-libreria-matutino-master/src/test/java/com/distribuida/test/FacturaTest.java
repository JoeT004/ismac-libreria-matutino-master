...
public class FacturaTest {
    ...
    public void setup() throws Exception {
        ...
        // Asignar fecha fija a la factura
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        fecha = sdf.parse("2023-08-15");

        // Crear Factura con datos fijos
        factura = new Factura(1, "F-001", fecha, 100.0, 12.0, 112.0, cliente);
    }
    ...
    public void testFacturaSetters() throws Exception {
        // Nueva fecha
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        Date nuevaFecha = sdf.parse("2023-09-01");
        ...
        assertAll("Validar datos Factura, Setters",
                ...
                () -> assertEquals(nuevaFecha, factura.getFecha()),
